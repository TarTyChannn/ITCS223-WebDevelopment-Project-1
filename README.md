...
│   ├── README.md                ← this file
│   ├── server.js                ← front-end static server (Express, port 8080)
│   ├── package.json             ← front-end dependencies
│   ├── script.js                ← shared Fetch API client module
│   ├── html/
│   │   ├── homepage.html        ← landing page (hero + carousel + search)
│   │   ├── buy_search.html      ← browse houses for sale
│   │   ├── renting_search.html  ← browse houses for rent
│   │   ├── team_page.html       ← team members page
│   │   ├── product_detail.html  ← property detail (fetches by ?id=)
│   │   ├── log_in.html          ← admin authentication page
│   │   ├── dashboard.html       ← admin Product Management (CRUD)
│   │   └── edit_page.html       ← admin: edit existing property
│   ├── css/                     ← external CSS files (one per page)
...
| Page | URL |
| ---- | --- |
| Homepage | <http://localhost:8080/html/homepage.html> |
| Buy listings | <http://localhost:8080/html/buy_search.html> |
| Rent listings | <http://localhost:8080/html/renting_search.html> |
| Team page | <http://localhost:8080/html/team_page.html> |
| Admin login | <http://localhost:8080/html/log_in.html> |
| Admin dashboard | <http://localhost:8080/html/dashboard.html> *(redirects if not logged in)* |
